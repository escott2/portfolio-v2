    ...
    <>
      ...
      >
        ...
        >
          ...
          <TypeAnimation
            sequence={["", 1500, "an experienced Software Engineer"]}
            wrapper="span"
            speed={80}
            cursor={false}
          ...
          />
          <TypeAnimation
            sequence={["", 2600, "and Health Information Specialist,"]}
            wrapper="span"
            speed={80}
            cursor={false}
            preRenderFirstString={false}
          ...
          />
          <TypeAnimation
            sequence={["", 3700, "building expertise in Health Informatics."]}
            wrapper="span"
            speed={80}
            cursor={false}
            preRenderFirstString={false}
